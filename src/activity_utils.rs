...
fn merge_assets(act: &mut Activity, script: &Activity, default: &Activity) {
    let mut assets = default.assets();
    merge_field!(assets, set_large_image, script.assets().large_image(), default.assets().large_image());
    merge_field!(assets, set_large_text, script.assets().large_text(), default.assets().large_text());
    merge_field!(assets, set_small_image, script.assets().small_image(), default.assets().small_image());
    merge_field!(assets, set_small_text, script.assets().small_text(), default.assets().small_text());
    *act = act.clone().set_assets(assets);
}
...
pub fn merge_activities(script: &Activity, default: &Activity) -> Activity {
    ...
    merge_assets(&mut act, script, default);
